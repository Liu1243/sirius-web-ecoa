...
import { ExportEcoaStepsMenuItem } from './ExportEcoaStepsMenuItem';
import { ImportEcoaStepsMenuItem } from './ImportEcoaStepsMenuItem';
import { ImportProjectMenuItem } from './ImportProjectMenuItem';
  ...
  return (
    <ContextMenuContainer>
      <Menu open anchorEl={anchorEl} data-testid="navbar-contextmenu" onClose={onClose}>
        ...
        <ExportEcoaStepsMenuItem project={project} onClick={onClose} />
        <ImportEcoaStepsMenuItem project={project} onClick={onClose} />
        {project.capabilities.canDownload ? (
          <DownloadProjectMenuItem project={project} name={name} onClick={onClose} />
        ) : null}
        <ImportProjectMenuItem project={project} onClick={onClose} />
