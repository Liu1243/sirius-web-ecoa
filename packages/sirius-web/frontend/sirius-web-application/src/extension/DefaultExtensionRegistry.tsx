...
import { DiagramsView } from '../views/edit-project/workbench-views/diagrams/DiagramsView';
...
import { ComponentHistoryView } from '../views/edit-project/workbench-views/component-history/ComponentHistoryView';
...
const workbenchViewContributions: WorkbenchViewContribution[] = [
  ...
  },
  {
    ...
    icon: <HistoryIcon />,
    component: ComponentHistoryView,
  },
];
