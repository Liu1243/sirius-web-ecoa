...
/**
 * Used to provide support for a custom details view for Edt objects.
 *
 * @author managerial
 */
@Service("edtDetailsViewPageDescriptionProvider")
public class EdtDetailsViewPageDescriptionProvider implements IPropertiesDescriptionRegistryConfigurer {
    ...
    public EdtDetailsViewPageDescriptionProvider(IFormDescriptionConverter formDescriptionConverter, List<IPageDescriptionProvider> pageDescriptionProviders) {
    ...
    public void addPropertiesDescriptions(IPropertiesDescriptionRegistry registry) {
        ...
        var viewFormDescription = new FormBuilders().newFormDescription()
                .name("Edt Details View")
                .domainType("edtproject:NamedElement") 
                // Using edtproject:NamedElement assuming base class. 
                // If common named element is not in project, I might need to adjust or use multiple descriptions.
                // Papaya uses papaya:NamedElement.
                // Let's assume edtproject has NamedElement or similar.
                // Most EDT elements likely inherit from a common NamedElement.
                .titleExpression("")
                .build();
