...
public class MessageService implements IMessageService {
    ...
    @Override
    public String relatedViewsLabel() {
        return this.messageSourceAccessor.getMessage("RELATED_VIEWS_LABEL");
    }
    ...
    @Override
    public String duplicateProjectName(String name) {
        return this.messageSourceAccessor.getMessage("DUPLICATE_PROJECT_NAME", new Object[] {name});
    }
}
