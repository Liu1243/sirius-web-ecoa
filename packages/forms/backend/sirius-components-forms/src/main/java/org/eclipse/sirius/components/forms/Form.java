...
public final class Form implements IRepresentation {
    ...
    public String toString() {
        String pattern = "{0} '{'id: {1}, targetObjectId: {2}, targetObjectLabel: {3}, descriptionId: {4}'}'";
        return MessageFormat.format(pattern, this.getClass().getSimpleName(), this.id, this.targetObjectId, this.targetObjectLabel, this.descriptionId);
    }
    ...
    public static final class Builder {
        ...
        private Builder(Form form) {
            ...
            this.targetObjectLabel = form.getTargetObjectLabel();
        ...
        public Form build() {
            ...
            form.targetObjectLabel = this.targetObjectLabel;
