...
/**
 * This is the item provider adapter for a {@link edtinterface.Event} object.
...
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
					...
					public void setPropertyValue(Object object, Object value) {
						Event operationToName = (Event) object;
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDTInterfacePackage.Literals.EVENT__DIRECTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTInterfacePackage.Literals.EVENT__INPUT);
		}
	...
	public String getText(Object object) {
		...
		String className = "Operation Event";
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTInterfacePackage.Literals.EVENT__INPUT,
