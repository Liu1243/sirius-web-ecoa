...
public class ComponentImplementationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
					...
					public void setPropertyValue(Object object, Object value) {
						...
						super.setPropertyValue(object, value);
						// NOTE: Sirius Desktop-specific representation renaming was removed
						// as it uses APIs not available in sirius-web (EcoadtServices, DialectManager,
						// TransactionalEditingDomain, RecordingCommand)
					}
				});
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EdtimplementationPackage.Literals.COMPONENT_IMPLEMENTATION__MODULE_TYPES);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EdtimplementationPackage.Literals.COMPONENT_IMPLEMENTATION__MODULE_TYPES,
				 EdtimplementationFactory.eINSTANCE.createModuleType()));

		newChildDescriptors.add
			(createChildParameter
				(EdtimplementationPackage.Literals.COMPONENT_IMPLEMENTATION__ASSOCIATED_SERVICE_QOS,
				 edtqos.EdtqosFactory.eINSTANCE.createServiceInstanceQos()));
