...
/**
 * This is the item provider adapter for a {@link edtimplementation.PropertyValue} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PropertyValue_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PropertyValue_value_feature",
								"_UI_PropertyValue_type"),
						EdtimplementationPackage.Literals.PROPERTY_VALUE__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null) {
					@Override
					public void setPropertyValue(Object object, Object value) {
						PropertyValue propertyValue = (PropertyValue) object;
						String str = (String) value;
						ModuleTypeProperty propertyType = propertyValue.getPropertyType();
						if (propertyType.getType() != null) {
							final String errorMessageToPopUp = "The value " + value
									+ " entered is not valid with the type " + propertyType.getType().getFullName()
									+ ". See console for more details.";
							if (str.startsWith("$") && propertyValue.getValueComponentDefinitionProperty() != null) {
								if (!Objects.equals(
										propertyValue.getValueComponentDefinitionProperty().getECOASCAType(),
										propertyType.getType())) {
									LOGGER.error("{}: {}", 
											"ERROR : the ComponentProperty reference is not correct.See console for more details.",
											" The ComponentProperty type and the ModuleType property are not equal");
									return;
								}
								LOGGER.warn("Warning : ComponentProperty values can not be verified.");
							}

							if (!EDTTypeValidator.validateValueAccordingToType(str, propertyType.getType(),
									errorMessageToPopUp)) {
								return;
							}
						}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdtimplementationPackage.Literals.PROPERTY_VALUE__NAME,
				 true,
				 false,
				 false,
