...
public class ComponentDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTProjectPackage.Literals.COMPONENT_DEFINITION__ASSOCIATED_SERVICE_QOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.COMPONENT_DEFINITION__ASSOCIATED_SERVICE_QOS,
