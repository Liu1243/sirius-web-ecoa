...
public class LogicalComputingPlatformItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIpAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				(createItemPropertyDescriptor
						(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
								getResourceLocator(),
								getString("_UI_LogicalComputingPlatform_ipAddress_feature"),
								getString("_UI_PropertyDescriptor_description", "_UI_LogicalComputingPlatform_ipAddress_feature", "_UI_LogicalComputingPlatform_type"),
								EdtlogicalPackage.Literals.LOGICAL_COMPUTING_PLATFORM__IP_ADDRESS,
								true,
								false,
								false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LogicalComputingPlatform.class)) {
			...
			case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM__IP_ADDRESS:
