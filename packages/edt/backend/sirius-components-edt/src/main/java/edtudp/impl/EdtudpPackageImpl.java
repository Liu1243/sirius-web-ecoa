...
public class EdtudpPackageImpl extends EPackageImpl implements EdtudpPackage {
	...
	public static EdtudpPackage init() {
		...
		// Initialize EdttcpPackage and EdtddsPackage before EdtuidPackage:
		// EdtuidPackageImpl.init() calls EDTProjectPackageImpl.initializePackageContents(),
		// which looks both packages up from the registry. Initializing them here first
		// ensures those lookups succeed.
