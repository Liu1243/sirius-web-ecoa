...
public class ServiceInstanceQosImpl extends MinimalEObjectImpl.Container implements ServiceInstanceQos {
	...
	private boolean isAlreadyPresentInQoS(Operation operation, Operation object) {
		return (object instanceof Data newData && operation instanceof Data opData
				&& (newData.getServiceDefinitionData() != null && opData.getServiceDefinitionData() != null
				&& Objects.equals(opData.getServiceDefinitionData(), newData.getServiceDefinitionData())))
				|| (object instanceof Event newEvent && operation instanceof Event opEvent
				&& (newEvent.getServiceDefinitionEvent() != null && opEvent.getServiceDefinitionEvent() != null
				&& Objects.equals(opEvent.getServiceDefinitionEvent(),
				newEvent.getServiceDefinitionEvent())))
				|| (object instanceof RequestResponse newRR && operation instanceof RequestResponse opRR
				&& (newRR.getServiceDefinitionRequestResponse() != null
				&& opRR.getServiceDefinitionRequestResponse() != null
				&& Objects.equals(opRR.getServiceDefinitionRequestResponse(),
				newRR.getServiceDefinitionRequestResponse())));
	}
