...
//		CONSTANT
			...
			return ((typeRef instanceof Simple simple && simple.getBasicType() != null
					...
					|| (typeRef instanceof SimplePredefined simplePredefined
					&& !Objects.equals(simplePredefined.getBasicType().getName(), BOOLEAN8))
...
//		ENUM
			...
			return ((typeRef instanceof Simple simple && simple.getBasicType() != null
					...
					|| (typeRef instanceof SimplePredefined simplePredefined2
					&& !Objects.equals(simplePredefined2.getBasicType().getName(), "int"))
