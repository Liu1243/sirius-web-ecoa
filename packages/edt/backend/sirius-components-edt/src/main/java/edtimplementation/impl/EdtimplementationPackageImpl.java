...
public class EdtimplementationPackageImpl extends EPackageImpl implements EdtimplementationPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getModuleType_Properties(), this.getModuleTypeProperty(), null, "Properties", null, 0, -1, ModuleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
