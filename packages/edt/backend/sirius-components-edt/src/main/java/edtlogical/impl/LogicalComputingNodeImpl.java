 ...
 * Version</em>}</li>
 * <li>{@link edtlogical.impl.LogicalComputingNodeImpl#getIpAddress <em>Ip
 * Address</em>}</li>
...
public class LogicalComputingNodeImpl extends MinimalEObjectImpl.Container implements LogicalComputingNode {
	...
	/**
	 * The default value of the '{@link #getIpAddress() <em>Ip Address</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getIpAddress()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getIpAddress() <em>Ip Address</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #getIpAddress()
	 * @generated
	...
	public void setIpAddress(String newIpAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtlogicalPackage.LOGICAL_COMPUTING_NODE__IP_ADDRESS,
