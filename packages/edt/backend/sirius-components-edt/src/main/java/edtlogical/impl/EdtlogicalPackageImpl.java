...
public class EdtlogicalPackageImpl extends EPackageImpl implements EdtlogicalPackage {
	 ...
	 */
	@Override
	public EAttribute getLogicalComputingPlatform_IpAddress() {
	...
	public EAttribute getLogicalComputingPlatform_Id() {
		return (EAttribute)logicalComputingPlatformEClass.getEStructuralFeatures().get(4);
	}
	...
	@Override
	public EAttribute getLogicalComputingPlatformLink_UseDDS() {
		return (EAttribute)logicalComputingPlatformLinkEClass.getEStructuralFeatures().get(7);
	}

	@Override
	public EAttribute getLogicalComputingPlatformLink_DdsDomainId() {
		return (EAttribute)logicalComputingPlatformLinkEClass.getEStructuralFeatures().get(8);
	}

	@Override
	public EAttribute getLogicalComputingPlatformLink_DdsTopicName() {
		return (EAttribute)logicalComputingPlatformLinkEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getLogicalComputingNode_IpAddress() {
		return (EAttribute)logicalComputingNodeEClass.getEStructuralFeatures().get(7);
	}
	...
	public EReference getLogicalComputingNode_ProtectionDomainLink() {
		return (EReference)logicalComputingNodeEClass.getEStructuralFeatures().get(8);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(logicalComputingPlatformEClass, LOGICAL_COMPUTING_PLATFORM__IP_ADDRESS);
		...
		createEAttribute(logicalComputingPlatformLinkEClass, LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS);
		createEAttribute(logicalComputingPlatformLinkEClass, LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID);
		createEAttribute(logicalComputingPlatformLinkEClass, LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME);
		...
		createEAttribute(logicalComputingNodeEClass, LOGICAL_COMPUTING_NODE__IP_ADDRESS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getLogicalComputingPlatform_IpAddress(), theXMLTypePackage.getString(), "ipAddress", null, 0, 1, LogicalComputingPlatform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLogicalComputingPlatformLink_UseDDS(), ecorePackage.getEBoolean(), "useDDS", "false", 0, 1, LogicalComputingPlatformLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLogicalComputingPlatformLink_DdsDomainId(), ecorePackage.getEInt(), "ddsDomainId", "0", 0, 1, LogicalComputingPlatformLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLogicalComputingPlatformLink_DdsTopicName(), ecorePackage.getEString(), "ddsTopicName", null, 0, 1, LogicalComputingPlatformLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLogicalComputingNode_IpAddress(), theXMLTypePackage.getString(), "ipAddress", null, 0, 1, LogicalComputingNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
				(getLogicalComputingPlatform_IpAddress(),
						source,
						new String[] {
								"kind", "attribute",
								"name", "ipAddress"
