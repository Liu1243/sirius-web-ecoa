...
public interface EdtlogicalPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM__IP_ADDRESS = 3;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM__ID = 4;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM_FEATURE_COUNT = 5;
	...
	/**
	 * The feature id for the '<em><b>Use DDS</b></em>' attribute.
	 * @generated
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS = 7;

	/**
	 * The feature id for the '<em><b>Dds Domain Id</b></em>' attribute.
	 * @generated
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID = 8;

	/**
	 * The feature id for the '<em><b>Dds Topic Name</b></em>' attribute.
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME = 9;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_PLATFORM_LINK_FEATURE_COUNT = 10;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_NODE__IP_ADDRESS = 7;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_NODE__PROTECTION_DOMAIN_LINK = 8;
	 ...
	 * @ordered
	 */
	int LOGICAL_COMPUTING_NODE_FEATURE_COUNT = 9;
	...
	/**
	 * Returns the meta object for the attribute '{@link edtlogical.LogicalComputingPlatform#getIpAddress <em>Ip Address</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Ip Address</em>'.
	 * @see edtlogical.LogicalComputingPlatform#getIpAddress()
	 * @see #getLogicalComputingPlatform()
	 * @generated
	 */
	EAttribute getLogicalComputingPlatform_IpAddress();
	...
	/**
	 * Returns the meta object for the attribute '{@link edtlogical.LogicalComputingPlatformLink#isUseDDS <em>Use DDS</em>}'.
	 * @return the meta object for the attribute '<em>Use DDS</em>'.
	 * @see edtlogical.LogicalComputingPlatformLink#isUseDDS()
	 * @see #getLogicalComputingPlatformLink()
	 * @generated
	 */
	EAttribute getLogicalComputingPlatformLink_UseDDS();

	/**
	 * Returns the meta object for the attribute '{@link edtlogical.LogicalComputingPlatformLink#getDdsDomainId <em>Dds Domain Id</em>}'.
	 * @return the meta object for the attribute '<em>Dds Domain Id</em>'.
	 * @see edtlogical.LogicalComputingPlatformLink#getDdsDomainId()
	 * @see #getLogicalComputingPlatformLink()
	 * @generated
	 */
	EAttribute getLogicalComputingPlatformLink_DdsDomainId();

	/**
	 * Returns the meta object for the attribute '{@link edtlogical.LogicalComputingPlatformLink#getDdsTopicName <em>Dds Topic Name</em>}'.
	 */
	EAttribute getLogicalComputingPlatformLink_DdsTopicName();
	...
	/**
	 * Returns the meta object for the attribute '{@link edtlogical.LogicalComputingNode#getIpAddress <em>Ip Address</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Ip Address</em>'.
	 * @see edtlogical.LogicalComputingNode#getIpAddress()
	 * @see #getLogicalComputingNode()
	 * @generated
	 */
	EAttribute getLogicalComputingNode_IpAddress();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute LOGICAL_COMPUTING_PLATFORM__IP_ADDRESS = eINSTANCE.getLogicalComputingPlatform_IpAddress();
		...
		/**
		 * The meta object literal for the '<em><b>Use DDS</b></em>' attribute feature.
		 * @generated
		 */
		EAttribute LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS = eINSTANCE.getLogicalComputingPlatformLink_UseDDS();

		/**
		 * The meta object literal for the '<em><b>Dds Domain Id</b></em>' attribute feature.
		 * @generated
		 */
		EAttribute LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID = eINSTANCE.getLogicalComputingPlatformLink_DdsDomainId();

		EAttribute LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME = eINSTANCE.getLogicalComputingPlatformLink_DdsTopicName();
		 ...
		 * @generated
		 */
		EAttribute LOGICAL_COMPUTING_NODE__IP_ADDRESS = eINSTANCE.getLogicalComputingNode_IpAddress();
