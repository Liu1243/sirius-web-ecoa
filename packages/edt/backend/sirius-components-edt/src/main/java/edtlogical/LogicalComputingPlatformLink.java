...
public interface LogicalComputingPlatformLink extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Use DDS</b></em>' attribute.
	 *
	 * @return whether DDS middleware is enabled for this platform link.
	 * @see #setUseDDS(boolean)
	 * @see edtlogical.EdtlogicalPackage#getLogicalComputingPlatformLink_UseDDS()
	...
	/**
	 * Sets the value of the '{@link edtlogical.LogicalComputingPlatformLink#isUseDDS <em>Use DDS</em>}' attribute.
	 *
	 * @param value the new value.
	 * @see #isUseDDS()
	 * @generated
	 */
	void setUseDDS(boolean value);

	/**
	 * Returns the value of the '<em><b>Dds Domain Id</b></em>' attribute.
	 *
	 * @return the CycloneDDS domain ID (0-232).
	 * @see #setDdsDomainId(int)
	 * @see edtlogical.EdtlogicalPackage#getLogicalComputingPlatformLink_DdsDomainId()
	...
	/**
	 * Sets the value of the '{@link edtlogical.LogicalComputingPlatformLink#getDdsDomainId <em>Dds Domain Id</em>}' attribute.
	 *
	 * @param value the new DDS domain ID (0-232).
	 * @see #getDdsDomainId()
	 * @generated
	 */
	void setDdsDomainId(int value);

	/**
	 * Returns the DDS topic name (optional; defaults to "LdpLocalPeerData").
	 */
	String getDdsTopicName();

	/**
	 * Sets the DDS topic name.
	 */
	void setDdsTopicName(String value);
