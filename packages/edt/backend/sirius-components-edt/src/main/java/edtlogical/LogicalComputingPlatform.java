 ...
 *   <li>{@link edtlogical.LogicalComputingPlatform#getIpAddress <em>Ip Address</em>}</li>
...
public interface LogicalComputingPlatform extends EObject {
	 ...
	 * @see edtlogical.EdtlogicalPackage#getLogicalComputingPlatform_IpAddress()
	 * @model
	...
	/**
	 * Sets the value of the '{@link edtlogical.LogicalComputingPlatform#getIpAddress <em>Ip Address</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
