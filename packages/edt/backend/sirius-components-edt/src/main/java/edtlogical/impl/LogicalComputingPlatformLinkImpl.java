...
public class LogicalComputingPlatformLinkImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The default value of the '{@link #isUseDDS() <em>Use DDS</em>}' attribute.
	 * @generated
	 * @ordered
	 */
	protected static final boolean USE_DDS_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isUseDDS() <em>Use DDS</em>}' attribute.
	 * @generated
	 * @ordered
	 */
	protected boolean useDDS = USE_DDS_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final int DDS_DOMAIN_ID_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int ddsDomainId = DDS_DOMAIN_ID_EDEFAULT;

	protected static final String DDS_TOPIC_NAME_EDEFAULT = null;

	protected String ddsTopicName = DDS_TOPIC_NAME_EDEFAULT;
	...
	@Override
	public boolean isUseDDS() {
		return useDDS;
	}

	@Override
	public void setUseDDS(boolean newUseDDS) {
		boolean oldUseDDS = useDDS;
		useDDS = newUseDDS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS, oldUseDDS, useDDS));
	}

	@Override
	public int getDdsDomainId() {
		return ddsDomainId;
	}

	@Override
	public void setDdsDomainId(int newDdsDomainId) {
		int oldDdsDomainId = ddsDomainId;
		ddsDomainId = newDdsDomainId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID, oldDdsDomainId, ddsDomainId));
	}

	@Override
	public String getDdsTopicName() {
		return ddsTopicName;
	}

	@Override
	public void setDdsTopicName(String newDdsTopicName) {
		String oldDdsTopicName = ddsTopicName;
		ddsTopicName = newDdsTopicName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME, oldDdsTopicName, ddsTopicName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS:
			return isUseDDS();
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID:
			return getDdsDomainId();
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME:
			return getDdsTopicName();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__TRANSPORT_BINDING_PROTOCOL:
			...
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS:
			setUseDDS((Boolean) newValue);
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID:
			setDdsDomainId((Integer) newValue);
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME:
			setDdsTopicName((String) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__TRANSPORT_BINDING_PROTOCOL:
			...
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS:
			setUseDDS(USE_DDS_EDEFAULT);
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID:
			setDdsDomainId(DDS_DOMAIN_ID_EDEFAULT);
			return;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME:
			setDdsTopicName(DDS_TOPIC_NAME_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__USE_DDS:
			return useDDS != USE_DDS_EDEFAULT;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_DOMAIN_ID:
			return ddsDomainId != DDS_DOMAIN_ID_EDEFAULT;
		case EdtlogicalPackage.LOGICAL_COMPUTING_PLATFORM_LINK__DDS_TOPIC_NAME:
			return DDS_TOPIC_NAME_EDEFAULT == null ? ddsTopicName != null : !DDS_TOPIC_NAME_EDEFAULT.equals(ddsTopicName);
		}
	...
	public String toString() {
		...
		result.append(transportBindingProtocol);
		result.append(", useDDS: ");
		result.append(useDDS);
		result.append(", ddsDomainId: ");
		result.append(ddsDomainId);
		result.append(", ddsTopicName: ");
		result.append(ddsTopicName);
		result.append(')');
