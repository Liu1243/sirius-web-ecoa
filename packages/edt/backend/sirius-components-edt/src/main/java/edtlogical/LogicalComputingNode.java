 ...
 * Version</em>}</li>
 * <li>{@link edtlogical.LogicalComputingNode#getIpAddress <em>Ip Address</em>}</li>
...
public interface LogicalComputingNode extends EObject {
	 ...
	 * @see edtlogical.EdtlogicalPackage#getLogicalComputingNode_IpAddress()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	 * @generated
	 */
	String getIpAddress();
	...
	/**
	 * Sets the value of the '{@link edtlogical.LogicalComputingNode#getIpAddress
