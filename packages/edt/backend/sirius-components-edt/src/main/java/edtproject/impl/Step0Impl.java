...
public class Step0Impl extends MinimalEObjectImpl.Container implements Step0 {
	...
	public EDTDataType findInAllLibraries(String nameOfAssociatedLibrary, String nameOfType) {
		...
		if (findLibrary == null) {
			LOGGER.warn("No Library has the name :" + nameOfAssociatedLibrary);
			return null;
		}
		...
		LOGGER.warn("No Type has the name " + nameOfType + " in the Library " + nameOfAssociatedLibrary);
		return null;
	}
	...
	public EDTDataType findBasicTypeOrPredefined(String nameOfAssociatedType) {
		...
		LOGGER.warn("There is no BasicType or predefined type with the name " + nameOfAssociatedType
