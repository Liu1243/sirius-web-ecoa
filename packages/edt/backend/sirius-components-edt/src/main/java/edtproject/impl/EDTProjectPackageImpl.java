...
import edtdds.impl.EdtddsPackageImpl;
import edttcp.EdttcpPackage;
import edttcp.TCPBinding;
import edttcp.impl.EdttcpPackageImpl;
...
public class EDTProjectPackageImpl extends EPackageImpl implements EDTProjectPackage {
	...
	public static EDTProjectPackage init() {
		...
		registeredPackage = EPackage.Registry.INSTANCE.getEPackage(EdttcpPackage.eNS_URI);
		EdttcpPackageImpl theEdttcpPackage = (EdttcpPackageImpl)(registeredPackage instanceof EdttcpPackageImpl ? registeredPackage : EdttcpPackage.eINSTANCE);
		registeredPackage = EPackage.Registry.INSTANCE.getEPackage(EdtddsPackage.eNS_URI);
		EdtddsPackageImpl theEdtddsPackage = (EdtddsPackageImpl)(registeredPackage instanceof EdtddsPackageImpl ? registeredPackage : EdtddsPackage.eINSTANCE);
		...
		theEdtddsPackage.createPackageContents();
		...
		theEdtddsPackage.initializePackageContents();
	...
	@Override
	public EReference getStep5_TCPBindings() {
		return (EReference)step5EClass.getEStructuralFeatures().get(6);
	}

	@Override
	public EReference getStep5_DDSBindings() {
		return (EReference)step5EClass.getEStructuralFeatures().get(7);
	}
	...
	public void createPackageContents() {
		...
		createEReference(step5EClass, STEP5__TCP_BINDINGS);
		createEReference(step5EClass, STEP5__DDS_BINDINGS);
	...
	public void initializePackageContents() {
		...
		EdttcpPackage theEdttcpPackage = (EdttcpPackage)EPackage.Registry.INSTANCE.getEPackage(EdttcpPackage.eNS_URI);
		EdtddsPackage theEdtddsPackage = (EdtddsPackage)EPackage.Registry.INSTANCE.getEPackage(EdtddsPackage.eNS_URI);
		...
		initEReference(getStep5_TCPBindings(), theEdttcpPackage.getTCPBinding(), null, "TCPBindings", null, 0, -1, Step5.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStep5_DDSBindings(), theEdtddsPackage.getDDSBinding(), null, "DDSBindings", null, 0, -1, Step5.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
