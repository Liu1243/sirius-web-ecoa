...
public interface Step5 extends Step {
	...
	/**
	 * Returns the value of the '<em><b>TCP Bindings</b></em>' containment reference
	 * list. The list contents are of type {@link edttcp.TCPBinding}.
	 *
	 * @return the value of the '<em>TCP Bindings</em>' containment reference list.
	 * @see edtproject.EDTProjectPackage#getStep5_TCPBindings()
	 * @model containment="true"
	 */
	EList<TCPBinding> getTCPBindings();

	/**
	 * Returns the value of the '<em><b>DDS Bindings</b></em>' containment reference
	 * list. The list contents are of type {@link edtdds.DDSBinding}.
	 *
	 * @return the value of the '<em>DDS Bindings</em>' containment reference list.
	 * @see edtproject.EDTProjectPackage#getStep5_DDSBindings()
	 * @model containment="true"
	 */
	EList<DDSBinding> getDDSBindings();
