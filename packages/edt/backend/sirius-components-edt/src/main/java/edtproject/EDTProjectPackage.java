...
public interface EDTProjectPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>TCP Bindings</b></em>' containment reference list.
	 * @ordered
	 */
	int STEP5__TCP_BINDINGS = STEP_FEATURE_COUNT + 6;

	/**
	 * The feature id for the '<em><b>DDS Bindings</b></em>' containment reference list.
	 * @ordered
	 */
	int STEP5__DDS_BINDINGS = STEP_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int STEP5_FEATURE_COUNT = STEP_FEATURE_COUNT + 8;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link edtproject.Step5#getTCPBindings <em>TCP Bindings</em>}'.
	 * @return the meta object for the containment reference list '<em>TCP Bindings</em>'.
	 * @see edtproject.Step5#getTCPBindings()
	 * @see #getStep5()
	 */
	EReference getStep5_TCPBindings();

	/**
	 * Returns the meta object for the containment reference list '{@link edtproject.Step5#getDDSBindings <em>DDS Bindings</em>}'.
	 * @return the meta object for the containment reference list '<em>DDS Bindings</em>'.
	 * @see edtproject.Step5#getDDSBindings()
	 * @see #getStep5()
	 */
	EReference getStep5_DDSBindings();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>TCP Bindings</b></em>' containment reference list feature.
		 */
		EReference STEP5__TCP_BINDINGS = eINSTANCE.getStep5_TCPBindings();

		/**
		 * The meta object literal for the '<em><b>DDS Bindings</b></em>' containment reference list feature.
		 */
		EReference STEP5__DDS_BINDINGS = eINSTANCE.getStep5_DDSBindings();
