...
public class Step5Impl extends MinimalEObjectImpl.Container implements Step5 {
	...
	protected EList<TCPBinding> tcpBindings;
	protected EList<DDSBinding> ddsBindings;
	/**
	...
	@Override
	public EList<TCPBinding> getTCPBindings() {
		if (tcpBindings == null) {
			tcpBindings = new EObjectContainmentEList<>(TCPBinding.class, this, EDTProjectPackage.STEP5__TCP_BINDINGS);
		}
		return tcpBindings;
	}

	@Override
	public EList<DDSBinding> getDDSBindings() {
		if (ddsBindings == null) {
			ddsBindings = new EObjectContainmentEList<>(DDSBinding.class, this, EDTProjectPackage.STEP5__DDS_BINDINGS);
		}
		return ddsBindings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case EDTProjectPackage.STEP5__TCP_BINDINGS:
			return ((InternalEList<?>) getTCPBindings()).basicRemove(otherEnd, msgs);
		case EDTProjectPackage.STEP5__DDS_BINDINGS:
			return ((InternalEList<?>) getDDSBindings()).basicRemove(otherEnd, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EDTProjectPackage.STEP5__TCP_BINDINGS:
			return getTCPBindings();
		case EDTProjectPackage.STEP5__DDS_BINDINGS:
			return getDDSBindings();
		case EDTProjectPackage.STEP5__CROSS_PLATFORM_VIEW:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case EDTProjectPackage.STEP5__UDP_BINDINGS:
			...
			return;
		case EDTProjectPackage.STEP5__TCP_BINDINGS:
			getTCPBindings().clear();
			getTCPBindings().addAll((Collection<? extends TCPBinding>) newValue);
			return;
		case EDTProjectPackage.STEP5__DDS_BINDINGS:
			getDDSBindings().clear();
			getDDSBindings().addAll((Collection<? extends DDSBinding>) newValue);
			return;
		case EDTProjectPackage.STEP5__CROSS_PLATFORM_VIEW:
	...
	public boolean eIsSet(int featureID) {
		...
		case EDTProjectPackage.STEP5__TCP_BINDINGS:
			return tcpBindings != null && !tcpBindings.isEmpty();
		case EDTProjectPackage.STEP5__DDS_BINDINGS:
			return ddsBindings != null && !ddsBindings.isEmpty();
		case EDTProjectPackage.STEP5__CROSS_PLATFORM_VIEW:
