 ...
 * {@link technology.ecoa.bin.desc._2.BinaryModule} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class BinaryModuleItemProvider extends ItemProviderAdapter
	...
	protected void addChecksumPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						binPackage.Literals.BINARY_MODULE__CHECKSUM, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_heapSize_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__HEAP_SIZE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_object_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__OBJECT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_reference_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__REFERENCE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_stackSize_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__STACK_SIZE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_userContextSize_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__USER_CONTEXT_SIZE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryModule_warmStartContextSize_feature",
								"_UI_BinaryModule_type"),
						binPackage.Literals.BINARY_MODULE__WARM_START_CONTEXT_SIZE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(binPackage.Literals.BINARY_MODULE__BINARY_DEPENDENCY);
		}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_BinaryModule_type"), StyledString.Style.QUALIFIER_STYLER);
		} else {
			styledLabel.append(getString("_UI_BinaryModule_type"), StyledString.Style.QUALIFIER_STYLER)
					.append(" " + label);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(binPackage.Literals.BINARY_MODULE__BINARY_DEPENDENCY,
