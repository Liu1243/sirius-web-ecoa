 ...
 * {@link technology.ecoa.bin.desc._2.BinDesc} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class BinDescItemProvider extends ItemProviderAdapter
	...
	protected void addComponentImplementationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BinDesc_componentImplementation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BinDesc_componentImplementation_feature",
								"_UI_BinDesc_type"),
						binPackage.Literals.BIN_DESC__COMPONENT_IMPLEMENTATION, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinDesc_insertionPolicy_feature",
								"_UI_BinDesc_type"),
						binPackage.Literals.BIN_DESC__INSERTION_POLICY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_BinDesc_type"), StyledString.Style.QUALIFIER_STYLER);
		} else {
			styledLabel.append(getString("_UI_BinDesc_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(binPackage.Literals.BIN_DESC__PROCESSOR_TARGET,
				binFactory.eINSTANCE.createProcessorTarget()));

		newChildDescriptors.add(createChildParameter(binPackage.Literals.BIN_DESC__BINARY_MODULE,
