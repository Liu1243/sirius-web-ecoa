 ...
 * {@link technology.ecoa.bin.desc._2.DocumentRoot} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class DocumentRootItemProvider extends ItemProviderAdapter
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(binPackage.Literals.DOCUMENT_ROOT__BIN_DESC);
			childrenFeatures.add(binPackage.Literals.DOCUMENT_ROOT__USE);
		}
	...
	public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_DocumentRoot_type"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(binPackage.Literals.DOCUMENT_ROOT__BIN_DESC,
				binFactory.eINSTANCE.createBinDesc()));

		newChildDescriptors.add(
				createChildParameter(binPackage.Literals.DOCUMENT_ROOT__USE, binFactory.eINSTANCE.createUseType()));
	}
