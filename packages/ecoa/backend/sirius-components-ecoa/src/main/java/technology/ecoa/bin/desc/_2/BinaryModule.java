 ...
 *
 * <!-- begin-model-doc --> Technical description of the binary module
 *
 * <!-- end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getBinaryDependency
 * <em>Binary Dependency</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getChecksum
 * <em>Checksum</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getHeapSize <em>Heap
 * Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getObject
 * <em>Object</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getReference
 * <em>Reference</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getStackSize <em>Stack
 * Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getUserContextSize
 * <em>User Context Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinaryModule#getWarmStartContextSize
 * <em>Warm Start Context Size</em>}</li>
 * </ul>
 *
...
public interface BinaryModule extends EObject {
	/**
	 * Returns the value of the '<em><b>Binary Dependency</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link technology.ecoa.bin.desc._2.BinaryDependency}. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @return the value of the '<em>Binary Dependency</em>' containment reference
	 *         list.
	 ...
	 *        name='binaryDependency' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Checksum of
	 * the binary <!-- end-model-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> maximum
	 * size in bytes of the heap (memory dynamically allocated by the module binary
	 * itself: malloc or object instances)
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Filename of
	 * the binary implementing the referenced module. The filename may contain path
	 * information relative to the bin-desc location e.g. "binaries/module.o"
	 * relates a file 'module.o' located in a subdirectory 'binaries' of the
	 * directory containing the bin-desc file. Separators are '/'
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Name of the
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> maximum
	 * size in bytes of the stack used by any module entry point (including all
	 * sub-function calls)
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Size in
	 * bytes of the module user context
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Size
	 * in bytes of the module warm start context
	 *
	 * <!-- end-model-doc -->
	 *
