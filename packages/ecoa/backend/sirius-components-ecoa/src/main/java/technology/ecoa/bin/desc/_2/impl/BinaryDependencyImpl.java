 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryDependencyImpl#getChecksum
 * <em>Checksum</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryDependencyImpl#getObject
 * <em>Object</em>}</li>
 * </ul>
 *
 * @generated
...
public class BinaryDependencyImpl extends MinimalEObjectImpl.Container implements BinaryDependency {
	...
	public void setChecksum(String newChecksum) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_DEPENDENCY__CHECKSUM, oldChecksum,
					checksum));
		}
	}
	...
	public void setObject(String newObject) {
		...
		object = newObject;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_DEPENDENCY__OBJECT, oldObject,
					object));
		}
	}
