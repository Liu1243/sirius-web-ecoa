 ...
 * '<em><b>Programming Language</b></em>', and utility methods for working with
 * them. <!-- end-user-doc --> <!-- begin-model-doc --> Programming languages
 * supported by ECOA bindings
 *
 * <!-- end-model-doc -->
 *
 * @see technology.ecoa.bin.desc._2.binPackage#getProgrammingLanguage()
...
public enum ProgrammingLanguage implements Enumerator {
	...
	/**
	 * The '<em><b>C1</b></em>' literal object. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #C1_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>Ada</b></em>' literal object. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #ADA_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>HI Ada</b></em>' literal object. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #HI_ADA_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>C1</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #C1
	 * @model literal="C++"
	...
	/**
	 * The '<em><b>Ada</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #ADA
	 * @model name="Ada"
	...
	/**
	 * The '<em><b>HI Ada</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #HI_ADA
	 ...
	 * @generated
	 */
	private static final ProgrammingLanguage[] VALUES_ARRAY = new ProgrammingLanguage[] { C, C1, ADA, JAVA, HI_ADA, };

	/**
	 * A public read-only list of all the '<em><b>Programming Language</b></em>'
	...
	/**
	 * Returns the '<em><b>Programming Language</b></em>' literal with the specified
	...
	public static ProgrammingLanguage get(String literal) {
		for (ProgrammingLanguage result : VALUES_ARRAY) {
