...
public class logPackageImpl extends EPackageImpl implements logPackage {
	 ...
	 * @generated
	 */
	public EAttribute getTransportBindingType_Dds() {
		return (EAttribute)transportBindingTypeEClass.getEStructuralFeatures().get(2);
	}

	/**
	 * @generated
	 */
	public EAttribute getTransportBindingType_DdsDomainId() {
		return (EAttribute)transportBindingTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(transportBindingTypeEClass, TRANSPORT_BINDING_TYPE__DDS);
		createEAttribute(transportBindingTypeEClass, TRANSPORT_BINDING_TYPE__DDS_DOMAIN_ID);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTransportBindingType_Dds(), theXMLTypePackage.getBoolean(), "dds", "false", 0, 1, TransportBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransportBindingType_DdsDomainId(), theXMLTypePackage.getUnsignedInt(), "ddsDomainId", "0", 0, 1, TransportBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getTransportBindingType_DdsDomainId(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "ddsDomainId"
