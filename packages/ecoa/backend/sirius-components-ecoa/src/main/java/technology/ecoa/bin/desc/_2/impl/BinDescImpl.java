 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinDescImpl#getProcessorTarget
 * <em>Processor Target</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinDescImpl#getBinaryModule
 * <em>Binary Module</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinDescImpl#getComponentImplementation
 * <em>Component Implementation</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinDescImpl#getInsertionPolicy
 * <em>Insertion Policy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinDescImpl extends MinimalEObjectImpl.Container implements BinDesc {
	/**
	 * The cached value of the '{@link #getProcessorTarget() <em>Processor
	 * Target</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	...
	/**
	 * The cached value of the '{@link #getBinaryModule() <em>Binary Module</em>}'
	...
	/**
	 * The default value of the '{@link #getComponentImplementation() <em>Component
	 * Implementation</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	...
	public NotificationChain basicSetProcessorTarget(ProcessorTarget newProcessorTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					binPackage.BIN_DESC__PROCESSOR_TARGET, oldProcessorTarget, newProcessorTarget);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setProcessorTarget(ProcessorTarget newProcessorTarget) {
		if (newProcessorTarget != processorTarget) {
			...
			if (processorTarget != null) {
				msgs = ((InternalEObject) processorTarget).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - binPackage.BIN_DESC__PROCESSOR_TARGET, null, msgs);
			}
			if (newProcessorTarget != null) {
				msgs = ((InternalEObject) newProcessorTarget).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - binPackage.BIN_DESC__PROCESSOR_TARGET, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BIN_DESC__PROCESSOR_TARGET,
					newProcessorTarget, newProcessorTarget));
		}
	}
	...
	public EList<BinaryModule> getBinaryModule() {
		if (binaryModule == null) {
			binaryModule = new EObjectContainmentEList<>(BinaryModule.class, this,
					binPackage.BIN_DESC__BINARY_MODULE);
		}
		return binaryModule;
	}
	...
	public void setComponentImplementation(String newComponentImplementation) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BIN_DESC__COMPONENT_IMPLEMENTATION,
	...
	public void setInsertionPolicy(String newInsertionPolicy) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BIN_DESC__INSERTION_POLICY,
	...
	public boolean eIsSet(int featureID) {
		...
		case binPackage.BIN_DESC__COMPONENT_IMPLEMENTATION:
			return COMPONENT_IMPLEMENTATION_EDEFAULT == null ? componentImplementation != null
					: !COMPONENT_IMPLEMENTATION_EDEFAULT.equals(componentImplementation);
		case binPackage.BIN_DESC__INSERTION_POLICY:
