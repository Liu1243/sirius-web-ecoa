 ...
 *
 * <!-- begin-model-doc --> Links between module implementations and binary
 * objects
 *
 * <!-- end-model-doc -->
 *
 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.BinDesc#getProcessorTarget
 * <em>Processor Target</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinDesc#getBinaryModule <em>Binary
 * Module</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinDesc#getComponentImplementation
 * <em>Component Implementation</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.BinDesc#getInsertionPolicy
...
public interface BinDesc extends EObject {
	/**
	 * Returns the value of the '<em><b>Processor Target</b></em>' containment
	 ...
	 *        name='processorTarget' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * end-user-doc -->
	 *
	 * @param value the new value of the '<em>Processor Target</em>' containment
	 *              reference.
	...
	/**
	 * Returns the value of the '<em><b>Binary Module</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link technology.ecoa.bin.desc._2.BinaryModule}. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 ...
	 * @model containment="true" required="true" extendedMetaData="kind='element'
	 *        name='binaryModule' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * <em>Component Implementation</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Link to an
	 * external table containing insertion policy data of the binary ECOA component
	 *
	 * <!-- end-model-doc -->
	 *
