 ...
 * @generated
 */
public class binSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case binPackage.BINARY_MODULE: {
			BinaryModule binaryModule = (BinaryModule) theEObject;
			T result = caseBinaryModule(binaryModule);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
		...
		case binPackage.BIN_DESC: {
			BinDesc binDesc = (BinDesc) theEObject;
			T result = caseBinDesc(binDesc);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
		...
		case binPackage.PROCESSOR_TARGET: {
			ProcessorTarget processorTarget = (ProcessorTarget) theEObject;
			T result = caseProcessorTarget(processorTarget);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
	 ...
	 * Dependency</em>'. <!-- begin-user-doc --> This implementation returns null;
	 ...
	 * @generated
	 */
	public T caseBinaryModule(BinaryModule object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bin
	 * Desc</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bin
	 *         Desc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBinDesc(BinDesc object) {
		return null;
	}
	 ...
	 * '<em>Processor Target</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Processor Target</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProcessorTarget(ProcessorTarget object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Use
	 * Type</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Use
	 *         Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
