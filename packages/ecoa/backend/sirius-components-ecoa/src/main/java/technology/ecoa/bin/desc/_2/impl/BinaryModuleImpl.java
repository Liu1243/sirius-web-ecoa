 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getBinaryDependency
 * <em>Binary Dependency</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getChecksum
 * <em>Checksum</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getHeapSize
 * <em>Heap Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getObject
 * <em>Object</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getReference
 * <em>Reference</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getStackSize
 * <em>Stack Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getUserContextSize
 * <em>User Context Size</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.BinaryModuleImpl#getWarmStartContextSize
...
public class BinaryModuleImpl extends MinimalEObjectImpl.Container implements BinaryModule {
	/**
	 * The cached value of the '{@link #getBinaryDependency() <em>Binary
	 * Dependency</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	...
	public EList<BinaryDependency> getBinaryDependency() {
		if (binaryDependency == null) {
			binaryDependency = new EObjectContainmentEList<>(BinaryDependency.class, this,
					binPackage.BINARY_MODULE__BINARY_DEPENDENCY);
		}
	...
	public void setChecksum(String newChecksum) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__CHECKSUM, oldChecksum,
					checksum));
		}
	}
	...
	public void setHeapSize(String newHeapSize) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__HEAP_SIZE, oldHeapSize,
					heapSize));
		}
	}
	...
	public void setReference(String newReference) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__REFERENCE, oldReference,
					reference));
		}
	}
	...
	public void setStackSize(String newStackSize) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__STACK_SIZE, oldStackSize,
					stackSize));
		}
	}
	...
	public void setUserContextSize(String newUserContextSize) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__USER_CONTEXT_SIZE,
	...
	public void setWarmStartContextSize(String newWarmStartContextSize) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, binPackage.BINARY_MODULE__WARM_START_CONTEXT_SIZE,
