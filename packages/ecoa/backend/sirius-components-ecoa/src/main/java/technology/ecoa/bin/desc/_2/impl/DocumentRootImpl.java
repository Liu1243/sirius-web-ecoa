 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.DocumentRootImpl#getBinDesc
 * <em>Bin Desc</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.impl.DocumentRootImpl#getUse
 * <em>Use</em>}</li>
 * </ul>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
					EStringToStringMapEntryImpl.class, this, binPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
					EStringToStringMapEntryImpl.class, this, binPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	...
	public NotificationChain basicSetBinDesc(BinDesc newBinDesc, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(binPackage.Literals.DOCUMENT_ROOT__BIN_DESC, newBinDesc,
				msgs);
	}
	...
	public void setBinDesc(BinDesc newBinDesc) {
		getMixed().set(binPackage.Literals.DOCUMENT_ROOT__BIN_DESC, newBinDesc);
	}
	...
	public void setUse(UseType newUse) {
		getMixed().set(binPackage.Literals.DOCUMENT_ROOT__USE, newUse);
	}
