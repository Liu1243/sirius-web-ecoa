...
public interface logPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Dds</b></em>' attribute.
	 * @generated
	 * @ordered
	 */
	int TRANSPORT_BINDING_TYPE__DDS = 2;
	 ...
	 * @ordered
	 */
	int TRANSPORT_BINDING_TYPE__DDS_DOMAIN_ID = 3;
	 ...
	 * @ordered
	 */
	int TRANSPORT_BINDING_TYPE_FEATURE_COUNT = 4;
	...
	/**
	 * Returns the meta object for the attribute '{@link technology.ecoa.logicalsystem._2.TransportBindingType#isDds <em>Dds</em>}'.
	 * @return the meta object for the attribute '<em>Dds</em>'.
	 * @see technology.ecoa.logicalsystem._2.TransportBindingType#isDds()
	 * @see #getTransportBindingType()
	 * @generated
	 */
	EAttribute getTransportBindingType_Dds();

	/**
	 * Returns the meta object for the attribute '{@link technology.ecoa.logicalsystem._2.TransportBindingType#getDdsDomainId <em>Dds Domain Id</em>}'.
	 * @return the meta object for the attribute '<em>Dds Domain Id</em>'.
	 * @see technology.ecoa.logicalsystem._2.TransportBindingType#getDdsDomainId()
	 * @see #getTransportBindingType()
	 * @generated
	 */
	EAttribute getTransportBindingType_DdsDomainId();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Dds</b></em>' attribute feature.
		 * @generated
		 */
		EAttribute TRANSPORT_BINDING_TYPE__DDS = eINSTANCE.getTransportBindingType_Dds();

		/**
		 * The meta object literal for the '<em><b>Dds Domain Id</b></em>' attribute feature.
		 * @generated
		 */
		EAttribute TRANSPORT_BINDING_TYPE__DDS_DOMAIN_ID = eINSTANCE.getTransportBindingType_DdsDomainId();
