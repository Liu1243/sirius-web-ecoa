...
public class binAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected binSwitch<Adapter> modelSwitch = new binSwitch<>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link technology.ecoa.bin.desc._2.BinDesc <em>Bin Desc</em>}'. <!--
	 ...
	 * Target</em>}'. <!-- begin-user-doc --> This default implementation returns
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link technology.ecoa.bin.desc._2.UseType <em>Use Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 *
