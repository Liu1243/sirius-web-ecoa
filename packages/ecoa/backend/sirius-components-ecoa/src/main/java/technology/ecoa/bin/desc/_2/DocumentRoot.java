 ...
 * </p>
 * <ul>
 * <li>{@link technology.ecoa.bin.desc._2.DocumentRoot#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.DocumentRoot#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.DocumentRoot#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link technology.ecoa.bin.desc._2.DocumentRoot#getBinDesc <em>Bin
 * Desc</em>}</li>
...
public interface DocumentRoot extends EObject {
	 ...
	 *        derived="true" extendedMetaData="kind='element' name='binDesc'
	 ...
	 * Desc</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Declares
	 * the use of a library of data types. A type T defined in a library L will be
	 * denoted "L:T".
	 *
	 * <!-- end-model-doc -->
	 *
	 ...
	 * @model containment="true" upper="-2" transient="true" volatile="true"
	 *        derived="true" extendedMetaData="kind='element' name='use'
	 *        namespace='##targetNamespace'"
	 * @generated
	 */
	UseType getUse();
	...
	/**
	 * Sets the value of the '{@link technology.ecoa.bin.desc._2.DocumentRoot#getUse
	 * <em>Use</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
