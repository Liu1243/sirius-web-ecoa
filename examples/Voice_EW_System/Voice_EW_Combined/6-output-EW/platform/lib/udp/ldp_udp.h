...
typedef struct ldp_socket_info ldp_socket_info; //! define in ldp_network.h
#if USE_UDP_PROTO
...
typedef struct ldp_interface_udp{
	ldp_socket_info* info_r;//!< info for the read socket
	ldp_socket_info* info_w;//!< info fot the written socket
