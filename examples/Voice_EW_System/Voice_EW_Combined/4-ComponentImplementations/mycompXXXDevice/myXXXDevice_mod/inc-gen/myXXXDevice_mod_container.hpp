...
*                date: 2026-08-06 02:31:45.579343    
*
* WARNING: all changes made in this file will be lost
*/

/**
* @file myXXXDevice_mod_container.hpp
* @brief This is the Module Container header for Module / Container Interface Class Header
*
*/

#if !defined(_MYXXXDEVICE_MOD_CONTAINER_HPP)
#define _MYXXXDEVICE_MOD_CONTAINER_HPP
...
class Container
{
	public:
        ...
        void voice_control__send(const Common_lib::voice_msg& voice_content);
        void voice_query__send(const Common_lib::voice_msg& voice_content);
    	/* Properties API */
...
#endif /* MYXXXDEVICE_MOD_CONTAINER_HPP */