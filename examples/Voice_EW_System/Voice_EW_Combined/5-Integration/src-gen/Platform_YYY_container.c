...
*                date: 2026-08-06 02:31:45.047442    
*
* WARNING: all changes made in this file will be lost
*/


/* Fault Handler Container Skeleton for  Platform_YYY */

/* @file Platform_YYY_container.c
        ...
        case ECOA__recovery_action_type_SHUTDOWN:
            {
                ...
                if (ctx->pd_processes_array[l_process_idx].state == PROCESS_RUNNING) {
                    ...
                    Platform_YYY_container__log_info(context, log);
