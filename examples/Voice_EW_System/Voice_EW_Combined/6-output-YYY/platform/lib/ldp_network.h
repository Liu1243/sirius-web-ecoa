...
typedef struct ldp_socket_info{
...
//! Compatibility name still emitted by generated platform sources.
typedef ldp_socket_info ldp_tcp_info;
 ...
 */
void ldp_IP_print_err(apr_status_t err, ldp_logger_platform* logger_PF, ldp_socket_info* ip_info);
