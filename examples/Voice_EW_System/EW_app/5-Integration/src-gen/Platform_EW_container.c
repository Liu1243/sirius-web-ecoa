...
*                date: 2026-08-05 23:50:21.958000    
*
* WARNING: all changes made in this file will be lost
*/


/* Fault Handler Container Skeleton for  Platform_EW */

/* @file Platform_EW_container.c
        ...
        case ECOA__recovery_action_type_SHUTDOWN:
            {
                ...
                if (ctx->pd_processes_array[l_process_idx].state == PROCESS_RUNNING) {
                    ...
                    Platform_EW_container__log_info(context, log);
