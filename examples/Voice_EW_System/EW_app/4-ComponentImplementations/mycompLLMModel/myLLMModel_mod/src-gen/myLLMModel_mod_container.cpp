...
*                date: 2026-08-05 23:50:21.953006    
*
* WARNING: all changes made in this file will be lost
*/

/* Module Container Implementation Skeleton for myLLMModel_mod */

/**
*  @file myLLMModel_mod_container.cpp
*  @brief This is the Module Container for Module  myLLMModel_mod
*
*/
...
namespace myLLMModel_mod
{
  ...
  void Container::json_control__send(const ECOA::uint16 topic_id, const Common_lib::json_text& payload){
    ldp_module_context* ctx=(ldp_module_context*) this->hook;
    uint32_t params_size = 0+sizeof(ECOA::uint16)+sizeof(Common_lib::json_text);
    ...
    if (ctx->operation_map[0].nb_ext_socket > 0){
        ...
        //serialize_ECOA__uint16(topic_id, &param_msg[total_added_size], max_size ,&added_size);
        //max_size -= added_size;
...
memcpy(&param_msg[LDP_HEADER_TCP_SIZE], &topic_id,sizeof(ECOA::uint16));
memcpy(&param_msg[LDP_HEADER_TCP_SIZE+sizeof(ECOA::uint16)], &payload,sizeof(Common_lib::json_text));
  ...
  ECOA::return_status Container::query_versioned_json__request_async(ECOA::uint32& ID){

    ldp_module_context* ctx=(ldp_module_context*) this->hook;
    if (ldp_check_concurrent_RR_num(ctx,0 , 10) != MOD_CONTAINER_OK){
        return ECOA::return_status::RESOURCE_NOT_AVAILABLE;
    }
    uint32_t params_size = sizeof(ECOA::uint32)+sizeof(ECOA::uint32);
    ldp__timestamp timeout_duration = {5, 0};
    ...
    if ((ctx->operation_map[1].nb_module > 0) ||
        ...
        retval = ldp_mod_request_async_send_local(ctx, &ID, param_msg, params_size,
                                                  &ctx->operation_map[1],
                                                  &timeout_duration);
    }else if(ctx->operation_map[1].nb_ext_socket > 0){
        //uint32_t added_size = 0;
