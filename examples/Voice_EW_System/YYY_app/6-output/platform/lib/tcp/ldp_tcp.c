...
ldp_status_t ldp_create_listen_sock(apr_socket_t** new_socket, apr_pool_t *mp, ldp_socket_info tcp_info){
 ...
 * @return apr status
 */
static ldp_status_t ldp_do_connect(apr_socket_t** new_socket, apr_pool_t *mp, ldp_socket_info tcp_info){
