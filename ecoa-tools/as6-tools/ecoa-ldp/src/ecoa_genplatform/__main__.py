...
def parse_args():
	...
	cmd_parser.add_argument('--platform', dest='platform_name', default=None,
							help="Platform name to generate for (overrides auto-detection from first protection domain)")
...
def main() -> None:
	...
	try:
		...
		# Override platform if specified via -pf
		if arguments.platform_name:
			Global_ECOA.current_PF_name = arguments.platform_name
